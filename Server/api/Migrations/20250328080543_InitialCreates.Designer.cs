...
namespace api.Migrations
{
    ...
    [Migration("20250328080543_InitialCreates")]
            ...
            modelBuilder.Entity("Entities.Enrolment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompletedDatetime = new DateTime(2025, 3, 28, 11, 5, 43, 66, DateTimeKind.Local).AddTicks(5619),
                            CourseId = new Guid("e1b2a3c4-d5e6-4f0a-b9a2-fd1234567890"),
                            EnrolmentDatetime = new DateTime(2025, 3, 28, 8, 5, 43, 66, DateTimeKind.Utc).AddTicks(5616),
                            Status = 0,
                        ...
                        new
                        {
                            ...
                            CompletedDatetime = new DateTime(2025, 3, 28, 11, 5, 43, 66, DateTimeKind.Local).AddTicks(5630),
                            CourseId = new Guid("b7f8c9e0-f1e2-4c3d-8f6b-cd9876543210"),
                            EnrolmentDatetime = new DateTime(2025, 3, 28, 8, 5, 43, 66, DateTimeKind.Utc).AddTicks(5629),
                            Status = 0,
            ...
            modelBuilder.Entity("Entities.QuizAttempt", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("a1b2c3d4-e5f6-4a2b-b9e0-abcdefabcdef"),
                            AttemptDatetime = new DateTime(2025, 3, 28, 8, 5, 43, 66, DateTimeKind.Utc).AddTicks(5772),
                            AttemptNumber = 0,
                            QuizId = new Guid("d4e5f6a7-b8c9-4d0a-b1c2-fd1234567890"),
                            ScoreAchieved = 85,
                            StudentId = new Guid("a6f8c3b4-bc6b-4e07-bb0d-bb8f7c6a3c9e")
                        ...
                        {
                            Id = new Guid("b2c3d4e5-f6a7-4b0c-b9e0-abcdefabcdef"),
                            AttemptDatetime = new DateTime(2025, 3, 28, 8, 5, 43, 66, DateTimeKind.Utc).AddTicks(5774),
                            AttemptNumber = 0,
                            QuizId = new Guid("a2b3c4d5-e6f7-4a8b-b9c2-fd1234567890"),
                            ScoreAchieved = 90,
                            StudentId = new Guid("c7babe27-ff5e-4e83-8dfb-2d90c58c7329")
            ...
            modelBuilder.Entity("Entities.StudentLesson", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompletedDatetime = new DateTime(2025, 3, 28, 8, 5, 43, 66, DateTimeKind.Utc).AddTicks(5696),
                        ...
                        new
                        {
                            ...
                            CompletedDatetime = new DateTime(2025, 3, 27, 8, 5, 43, 66, DateTimeKind.Utc).AddTicks(5698),
                            LessonId = new Guid("e1f2a3b4-c5d6-4e7f-b8a9-abcdefabcdef"),
                            Progress = false,
                            StudentId = new Guid("c7babe27-ff5e-4e83-8dfb-2d90c58c7329")
                        });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "89eb8a48-89b4-4800-a383-54d17dfb1484",
                            Name = "Manager",
                            NormalizedName = "MANAGER"
                        },
                        new
                        {
                            Id = "6a07c8b3-9d82-41c9-aeb8-5d2a50c98c4c",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "10020b39-6983-4e7d-9b10-f90024f020a3",
                            Name = "Instructor",
